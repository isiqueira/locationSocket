...
export default function CheckpointForm() {
  ...
  async function handleSubmit(e) {
    ...
    const payload = {
      ...
      gpsLocation: {
        type: 'Point',
        coordinates: [pinPosition[1], pinPosition[0]], // [lng, lat]
      },
    }
    setLoading(true)
    try {
  ...
  const center = pinPosition || [-15.77972, -47.92972]
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="card">
          ...
          <div className="map-container">
            <MapContainer center={center} zoom={pinPosition ? 13 : 5} style={{ height: '100%', width: '100%' }}>
              <TileLayer
